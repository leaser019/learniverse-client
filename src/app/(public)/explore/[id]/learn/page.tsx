...
const LearnPage = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (c && c.modules.length > 0) {
        for (const courseModule of c.modules) {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isFullscreen ? 'py-0' : 'py-4'}`}>
      <div
        className={`container mx-auto ${isFullscreen ? 'max-w-none px-0' : 'max-w-screen-xl px-4'}`}
      >
        {/* Top navigation bar */}
        {!isFullscreen && (
        ...
        <div
          className={`grid gap-6 ${isFullscreen ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-3'}`}
        >
          {/* Left - Video Player */}
            ...
            <div className="lg:col-span-1">
                            ...
                            <div className="flex flex-1 items-center justify-between">
                              <div className="text-left">
                                ...
                                <div className="text-sm text-gray-500">
                                  {courseModule.lessons.length} lessons • {courseModule.duration}
                                </div>
                              </div>
                              <div className="text-sm text-gray-500">
                                {
                                  courseModule.lessons.filter((l) =>
                                      ...
                                      <div>
                                        ...
                                        <div className="flex items-center gap-2 text-xs text-gray-500">
                                          ...
                                          {lesson.isFree && (
                                            <Badge
                                              variant="outline"
                                              className="ml-1 border-green-200 bg-green-50 px-1 py-0 text-[10px] text-green-600"
                                            >
                                              Free
                                            </Badge>
                                          )}
              ...
              <Card className="mt-6">
                <CardContent className="p-6">
                  ...
                  <div className="mt-6">
                    <Button variant="outline" className="w-full gap-2" onClick={askInstructor}>
