    ...
    <div className="mb-8">
      <div className="flex items-center justify-between">
        <div className="flex gap-2 flex-wrap">
          ...
          {selectedCategory && (
            <Button size="sm" variant="secondary" className="flex gap-1 items-center" onClick={() => setSelectedCategory(null)}>
          ...
          {selectedLevel && (
            <Button size="sm" variant="secondary" className="flex gap-1 items-center" onClick={() => setSelectedLevel(null)}>
          ...
          {selectedRating && (
            <Button size="sm" variant="secondary" className="flex gap-1 items-center" onClick={() => setSelectedRating(null)}>
              {ratings.find(r => r.value === selectedRating)?.label}
              <X size={14} />
            </Button>
          )}
          
          {(selectedCategory || selectedLevel || selectedRating || price[0] > 0 || price[1] < 2000000) && (
            <Button size="sm" variant="ghost" onClick={resetFilters} className="text-red-500 hover:text-red-700">
              Xóa bộ lọc
            </Button>
          )}
        </div>
